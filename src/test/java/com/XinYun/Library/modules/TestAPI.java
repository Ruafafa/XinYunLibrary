...
public class TestAPI {
    public static void main(String[] args) throws SQLException {
        ...
        TestEntity select = (TestEntity)SqlExecutor.select(connection1,sql1,new BeanHandler<TestEntity>(TestEntity.class));
        System.out.println(select);
        Connection connection2 = DruidUtil.getConnection();
        String sql2 = "UPDATE test1 SET name='ha' WHERE id = 3;";
